...
## Carmel Swirl
![Abstract wallpaper with warm colors and radial patterns](img/carmel-swirl.avif){.bg-warning w=200px align=left}
...
## Space Refraction
![Abstract wallpaper with sparse purple gas formations and spatial distortions](img/space-refraction.avif){.bg-warning w=200px align=left}
...
## Fiber Arches
![Abstract wallpaper with cool colors; a macro view of a fibrous material with lots of bokeh](img/ribbon-reunion.avif){.bg-warning w=200px align=left}
