...
class Point {
    constructor(vert, normal, UV) {
        ...
        // OBJs start counting at 1 for some reason.
        // this should be the actual array index that counts from 0.
        this.vert = vert;
        this.normal = normal;
        this.UV = UV;
    }
...
// Made references to the code in this guide:
...
function staticOBJMesh(gl, program, mesh) {
    ...
    // buffer normals
    // technically OBJs don't have to have face normals, but anything exported from blender should
    // have them
